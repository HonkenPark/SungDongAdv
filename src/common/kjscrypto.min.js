...
Array(16);this.decryptBlockOffset(a,0,k,0);return k};C.decryptBlockOffset=function(a,k,f,d){var b=8*(a.length-k);if(128>b)throw"ARIACrypto: Invalid ciphertext block bits ("+b+")";L(a,k,f,d,y,E)}}return{createInstance:function(){return new M}}}())})(window);
...
8,g[c+1]=a&255,a>>>=8,g[c]=a&255;return e},computeString:function(a){a=unescape(encodeURIComponent(a));for(var b=Array(a.length),e=0;e<b.length;e++)b[e]=a.charCodeAt(e);return l.KJSCrypto.SHA256.compute(b)}}}())})(window);
...
computeString:function(f,d){d=unescape(encodeURIComponent(d));for(var a=Array(d.length),c=0;c<a.length;c++)a[c]=d.charCodeAt(c);return b.KJSCrypto.HMAC.SHA256.compute(a,f)}}}())})(window);
...
b+2),16));return c},toByteArray:function(a){a=d(a);for(var c=Array(a.length),b=0;b<a.length;b++)c[b]=a.charCodeAt(b);return c},fromByteArray:function(a){for(var c="",b=0;b<a.length;b++)c+=String.fromCharCode(a[b]);return e(c)}}}()})(window);
...
0,b.length),d=0;d<a.length;d++)a[d]=b[d]}var l=!1,b=Array(32),e=0,h=c.KJSCrypto.Chacha20.createInstance();c.KJSCrypto.Utils.Array.fill(b,0,b.length,0);f(b,0,b.length);b=c.KJSCrypto.SHA256.compute(b);h.setKey(b,Array(8));l=!0;k(c,"mousemove",function(a){a=((new Date).getTime()+3)*((a.pageX||a.layerX)+3)*((a.pageY||a.layerY)+3);for(var g=0;4>g;g++)a>>>=8,b[e++]^=a&255,e>=b.length&&(b=c.KJSCrypto.SHA256.compute(b),e=0,h.setKey(b,Array(8)))});k(c,"keydown",function(a){a=((new Date).getTime()+
3)*((a.keyCode||a.which)+3);for(var g=0;4>g;g++)a>>>=8,b[e++]^=a&255,e>=b.length&&(b=c.KJSCrypto.SHA256.compute(b),e=0,h.setKey(b,Array(8)))});return{getValue:function(){var a=Array(1);f(a,0,1);return a[0]},getValues:function(a,b,c){f(a,b,c)}}}()})(window);
